...
const NotificationsPage = () => {
  ...
  return (
    <div className="flex bg-gray-100 justify-between w-full min-h-screen min-w-[320px] dark:bg-[#181818]">
      <div className="flex-1 p-6 bg-gray-100 w-full min-h-screen dark:bg-[#181818] min-w-0">
